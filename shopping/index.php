...
<html lang="en">
	<head>
	    ...
	    <title>Online Fruits and vegetables</title>
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
        ...
        <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/6.jpg);">
			</div><!-- /.item -->
		</div><!
	</div><!-- /.owl-carousel -->
</div>
		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">2 Day Money Back Guarantee.</h6>
				</div>
			</div><!-- .col -->
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Immune Boost Products</h3>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Organic Poducts</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
